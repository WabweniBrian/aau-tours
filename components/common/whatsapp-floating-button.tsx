  ...
  return (
    <div className="fixed bottom-10 right-4 z-50">
      ...
      <div className="relative">
        ...
        <button
          onClick={handleClick}
          className="group relative flex h-16 w-16 transform items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-green-600 shadow-2xl transition-all duration-300 hover:scale-110 hover:from-green-600 hover:to-green-700 hover:shadow-green-500/50 active:scale-95"
        ...
        {/* Optional tooltip */}
        <div className="absolute bottom-full right-0 mb-2 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-1 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          Chat with us
